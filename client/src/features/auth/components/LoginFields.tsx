...
import type { LoginFields as LoginFieldsType } from "../auth.schema";
...
export function LoginFields({
  ...
  emailRest: Omit<UseFormRegisterReturn<"email">, "ref">;
  emailFormRef: UseFormRegisterReturn<"email">["ref"];
  emailAutoFocusRef: React.RefObject<HTMLInputElement | null>;
  passwordRest: Omit<UseFormRegisterReturn<"password">, "ref">;
  passwordFormRef: UseFormRegisterReturn<"password">["ref"];
  errors: FieldErrors<LoginFieldsType>;
