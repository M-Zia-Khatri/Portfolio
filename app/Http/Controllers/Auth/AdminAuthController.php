...
{
    public function createLogin(Request $request): RedirectResponse|Response
    {
    ...
    public function createOtp(Request $request): RedirectResponse|Response
    {
        ...
        return Inertia::render('(auth)/OtpVerifyPage');
    }
    ...
    public function resendOtp(Request $request): RedirectResponse
    {
        ...
        return to_route('auth.otp.create')->with('status', 'A new verification code was sent to your email.');
    }
