...
function Label({ htmlFor, children }: { htmlFor: string; children: React.ReactNode }) {
  return (
    <label htmlFor={htmlFor} className={cn('mb-1.5 block text-xs font-medium tracking-wide select-none')} style={{ color: 'var(--gray-11)' }}>
      {children}
    </label>
  );
}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className={cn('absolute top-1/2 right-3 -translate-y-1/2', 'transition-colors duration-150')}
