      ...
      <Flex align="center" justify="between" px="6" height="64px">
        ...
        <Flex align="center" gap="4">
          ...
          <Flex align="center" gap="3">
            ...
            <Text size="3" weight="bold" className="hidden tracking-tight text-white select-none sm:block">
              Admin Portal
            </Text>
          </Flex>
        </Flex>
        ...
        <Flex align="center" gap="5">
            ...
            <Flex gap="5" align="center">
              {DEFAULT_NAV.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn('text-sm font-medium transition-colors hover:text-(--blue-11)', isActive ? 'text-(--blue-11)' : 'text-(--gray-10)')
                  }
                >
                  {item.label}
                </NavLink>
          ...
          <Flex align="center" gap="3">
            <Flex
              ...
              px="3"
              py="1"
              className="hidden rounded-full border border-(--gray-5) bg-(--gray-3)/50 font-mono text-[13px] text-(--blue-11) sm:flex"
            >
              <Clock size={14} className="opacity-70" />
              <span className="tabular-nums">{time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false })}</span>
            </Flex>
