...
export function appendHeroLineGradientDefs(svg: SVGSVGElement, height: number): void {
  ...
  const stops: { offset: string; color: string; opacity: string }[] = [
    ...
    { offset: '78%', color: top, opacity: '1' },
    { offset: '85%', color: top, opacity: '1' },
    { offset: '89%', color: top, opacity: '1' },
    { offset: '90%', color: top, opacity: '1' },
    { offset: '91%', color: top, opacity: '0.97' },
    { offset: '92.5%', color: top, opacity: '0.88' },
    { offset: '94%', color: top, opacity: '0.72' },
    { offset: '95.5%', color: top, opacity: '0.52' },
    { offset: '97%', color: toe, opacity: '0.28' },
    { offset: '98.25%', color: toe, opacity: '0.12' },
    { offset: '99.25%', color: toe, opacity: '0.035' },
